...
-- Date        : Fri Apr  3 11:50:18 2020
-- Host        : School running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               K:/ECE532/prj/project/project.srcs/sources_1/bd/design_1/ip/design_1_dlmb_bram_if_cntlr_1/design_1_dlmb_bram_if_cntlr_1_sim_netlist.vhdl
-- Design      : design_1_dlmb_bram_if_cntlr_1
...
entity design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr is
  port (
  ...
  attribute C_CE_COUNTER_WIDTH of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 0;
  attribute C_CE_FAILING_REGISTERS : integer;
  attribute C_CE_FAILING_REGISTERS of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 0;
  attribute C_ECC : integer;
  attribute C_ECC of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 0;
  attribute C_ECC_ONOFF_REGISTER : integer;
  attribute C_ECC_ONOFF_REGISTER of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 0;
  attribute C_ECC_ONOFF_RESET_VALUE : integer;
  attribute C_ECC_ONOFF_RESET_VALUE of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 1;
  attribute C_ECC_STATUS_REGISTERS : integer;
  attribute C_ECC_STATUS_REGISTERS of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 0;
  attribute C_FAMILY : string;
  attribute C_FAMILY of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "artix7";
  attribute C_FAULT_INJECT : integer;
  attribute C_FAULT_INJECT of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 0;
  attribute C_HIGHADDR : string;
  attribute C_HIGHADDR of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "64'b0000000000000000000000000000000000000000000000000000111111111111";
  ...
  attribute C_LMB_AWIDTH of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 32;
  attribute C_LMB_DWIDTH : integer;
  attribute C_LMB_DWIDTH of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 32;
  attribute C_MASK : string;
  attribute C_MASK of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "64'b0000000000000000000000000000000011000000000000000000000000000000";
  attribute C_MASK1 : string;
  attribute C_MASK1 of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "64'b0000000000000000000000000000000000000000100000000000000000000000";
  attribute C_MASK2 : string;
  attribute C_MASK2 of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "64'b0000000000000000000000000000000000000000100000000000000000000000";
  attribute C_MASK3 : string;
  attribute C_MASK3 of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "64'b0000000000000000000000000000000000000000100000000000000000000000";
  attribute C_NUM_LMB : integer;
  attribute C_NUM_LMB of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 1;
  attribute C_S_AXI_CTRL_ADDR_WIDTH : integer;
  attribute C_S_AXI_CTRL_ADDR_WIDTH of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 32;
  attribute C_S_AXI_CTRL_BASEADDR : string;
  attribute C_S_AXI_CTRL_BASEADDR of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "32'b11111111111111111111111111111111";
  attribute C_S_AXI_CTRL_DATA_WIDTH : integer;
  attribute C_S_AXI_CTRL_DATA_WIDTH of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 32;
  attribute C_S_AXI_CTRL_HIGHADDR : string;
  attribute C_S_AXI_CTRL_HIGHADDR of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "32'b00000000000000000000000000000000";
  attribute C_UE_FAILING_REGISTERS : integer;
  attribute C_UE_FAILING_REGISTERS of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 0;
  attribute C_WRITE_ACCESS : integer;
  attribute C_WRITE_ACCESS of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is 2;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr : entity is "lmb_bram_if_cntlr";
end design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr;

architecture STRUCTURE of design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dlmb_bram_if_cntlr_1 is
  port (
    LMB_Clk : in STD_LOGIC;
    LMB_Rst : in STD_LOGIC;
    LMB_ABus : in STD_LOGIC_VECTOR ( 0 to 31 );
  ...
  attribute NotValidForBitStream of design_1_dlmb_bram_if_cntlr_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_dlmb_bram_if_cntlr_1 : entity is "design_1_dlmb_bram_if_cntlr_1,lmb_bram_if_cntlr,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_dlmb_bram_if_cntlr_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_dlmb_bram_if_cntlr_1 : entity is "lmb_bram_if_cntlr,Vivado 2018.1";
end design_1_dlmb_bram_if_cntlr_1;

architecture STRUCTURE of design_1_dlmb_bram_if_cntlr_1 is
  ...
  attribute x_interface_parameter of BRAM_Rst_A : signal is "XIL_INTERFACENAME BRAM_PORT, MEM_SIZE 4096, MASTER_TYPE BRAM_CTRL, MEM_WIDTH 32, MEM_ECC NONE";
...
begin
U0: entity work.design_1_dlmb_bram_if_cntlr_1_lmb_bram_if_cntlr
     port map (
