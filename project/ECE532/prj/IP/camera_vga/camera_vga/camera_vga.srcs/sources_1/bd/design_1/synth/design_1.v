...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLOCK, ASSOCIATED_BUSIF axi_slave, ASSOCIATED_RESET aresetn, CLK_DOMAIN design_1_clock, FREQ_HZ 100000000, PHASE 0.000" *) input clock;
  ...
  wire [7:0]d_0_1;
  wire [17:0]hdrvga_v2_0_frame_addr;
  wire [3:0]hdrvga_v2_0_vga_blue;
  wire [3:0]hdrvga_v2_0_vga_green;
  wire hdrvga_v2_0_vga_hsync;
  wire [3:0]hdrvga_v2_0_vga_red;
  wire hdrvga_v2_0_vga_vsync;
  wire href_0_1;
  wire [0:0]mux_2to1_1_o;
  wire [1:0]out_data_ctrl_o;
  ...
  assign vga_b[3:0] = hdrvga_v2_0_vga_blue;
  assign vga_g[3:0] = hdrvga_v2_0_vga_green;
  assign vga_hsync = hdrvga_v2_0_vga_hsync;
  assign vga_r[3:0] = hdrvga_v2_0_vga_red;
  assign vga_vsync = hdrvga_v2_0_vga_vsync;
  ...
  design_1_hdrvga_v2_0_1 hdrvga_v2_0
       (.clk25(clk_wiz_0_clk_25),
        .frame_addr(hdrvga_v2_0_frame_addr),
        .frame_high(blk_mem_gen_0_doutb),
        .frame_low(blk_mem_gen_1_doutb),
        .sel(out_data_ctrl_o),
        .vga_blue(hdrvga_v2_0_vga_blue),
        .vga_green(hdrvga_v2_0_vga_green),
        .vga_hsync(hdrvga_v2_0_vga_hsync),
        .vga_red(hdrvga_v2_0_vga_red),
        .vga_vsync(hdrvga_v2_0_vga_vsync));
