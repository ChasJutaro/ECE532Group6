...
module I2C_Controller (
    ...
    always @(posedge iCLK or negedge iRST_N) begin
        ...
        else if(I2C_EN)	begin	//data change enable
            if(GO) begin
                if(WR) begin		//I2C Write: ID-Address + SUB-Address + W-Data
                    case(SD_COUNTER)
                        //IDLE
                        6'd0 :	begin
                                SCLK <= 1;
                ...
                else begin		//I2C Read: {ID-Address + SUB-Address} + {ID-Address + R-Data}
                    case(SD_COUNTER)
                        //IDLE
                        6'd0 :	begin
                                SCLK <= 1;
