...
HD_PWD='C:/Users/Will/Desktop/ECE532 Project/prj/IP/camera_vga/IP/hdrvga/hdrvga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga444.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga444.tcl -notrace
