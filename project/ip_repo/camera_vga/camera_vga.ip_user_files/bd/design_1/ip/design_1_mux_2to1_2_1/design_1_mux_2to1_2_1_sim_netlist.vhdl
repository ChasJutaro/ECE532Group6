...
--               K:/ECE532/prj/IP/camera_vga/camera_vga/camera_vga.srcs/sources_1/bd/design_1/ip/design_1_mux_2to1_2_1/design_1_mux_2to1_2_1_sim_netlist.vhdl
...
entity design_1_mux_2to1_2_1_mux2to1 is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_mux_2to1_2_1_mux2to1 : entity is "mux2to1";
end design_1_mux_2to1_2_1_mux2to1;

architecture STRUCTURE of design_1_mux_2to1_2_1_mux2to1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_mux_2to1_2_1 is
  port (
    sel : in STD_LOGIC;
    a : in STD_LOGIC_VECTOR ( 17 downto 0 );
    b : in STD_LOGIC_VECTOR ( 17 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_mux_2to1_2_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_mux_2to1_2_1 : entity is "design_1_mux_2to1_2_1,mux2to1,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_mux_2to1_2_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_mux_2to1_2_1 : entity is "mux2to1,Vivado 2018.1";
end design_1_mux_2to1_2_1;

architecture STRUCTURE of design_1_mux_2to1_2_1 is
begin
inst: entity work.design_1_mux_2to1_2_1_mux2to1
     port map (
