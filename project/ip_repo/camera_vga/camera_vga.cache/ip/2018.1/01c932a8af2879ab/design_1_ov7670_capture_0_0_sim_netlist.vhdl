...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cc_generator is
  ...
  attribute SOFT_HLUTNM of \cc__0\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \counter[2]_i_2\ : label is "soft_lutpair0";
begin
\cc__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
