...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, prog_trig, sel, config_finished, sioc, siod, 
  reset, pwdn, xclk)
/* synthesis syn_black_box black_box_pad_pin="clk,prog_trig,sel,config_finished,sioc,siod,reset,pwdn,xclk" */;
  input clk;
  input prog_trig;
  input sel;
